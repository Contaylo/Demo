...
public class Cat {
	...
	// nose dimensions
	private static final int NOSE_DIAMETER = HEAD_DIMENSION/5;
	//nose starts in middle of face.
	private static final int NOSE_X = HEAD_DIMENSION/2 - NOSE_DIAMETER/2;
	private static final int NOSE_Y = HEAD_DIMENSION/2 - NOSE_DIAMETER/4;
	//ear dimensions
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		x = catX + NOSE_X;
		y = catY + NOSE_Y;
		g2.fillOval(x,y, NOSE_DIAMETER, NOSE_DIAMETER);
